 ...
 */
public class WeeklyVisitingHourCriteria implements Serializable {
    /**
    ...
    public boolean equals(Object o) {
        ...
        final WeeklyVisitingHourCriteria that = (WeeklyVisitingHourCriteria) o;
        return
    ...
    public String toString() {
        return "WeeklyVisitingHourCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
